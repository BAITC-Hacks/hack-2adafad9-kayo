...
Первый экран — интерактивная 3D-сцена двух турбин. Ползунок показывает каждый час выбранного
48-часового выпуска: P50, диапазон P10–P90, прогноз скорости и направления ветра на высоте 100 м.
Скорость и направление взяты из архивного прогноза Open-Meteo Previous Runs API того же выпуска,
что использован моделью. Линии потока и скорость вращения лопастей иллюстрируют этот прогноз;
фактические обороты и ориентация турбин в исходных данных не указаны. Сцена работает через локальный
