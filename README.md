...
«Наше решение» измерено тем же агентным циклом, который выпускает февраль: 93 ежедневных выпуска
на ноябре — январе, с рефлексией и шлюзом качества. Рядом — та же модель без агента и лестница
...
| --- | --- | --- | --- | --- |
| **Наше решение (агентный цикл)** | **0,163** | **0,178** | **0,58** | **0,54** |
