...
Покрытие коридора P10–P90: **78 %** при средней ширине 0,45 (цель — около 80 %). Достигается
конформной калибровкой: квантильные модели учатся без последних 30 суток обучения, а на этом срезе
оценивается конформный отступ — отдельно на пару «турбина × горизонт», потому что у 48 ч разброс
шире. Модель медианы при этом учится на всей выборке.
